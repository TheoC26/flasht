  ...
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col justify-center items-center">
      ...
      <div className="bg-white text-[#303030] flashcard-shadow-dark rounded-4xl px-10 pt-8 pb-10 mb-4 w-full max-w-[620px] font-bold">
        <h1 className="text-5xl font-bold text-left mb-6">Sign Up</h1>
        ...
        <form onSubmit={handleSignup}>
          ...
          <div className="mb-3 relative">
            <input
              className="flashcard-shadow appearance-none border-1 border-[#DDDDDD] placeholder:text-[#B3B3B3] rounded-2xl text-xl w-full py-2 px-3 pr-10 text-[#303030] bg-[#f1f1f1] leading-tight focus:outline-none focus:shadow-outline"
              id="password"
          ...
          <div className="flex items-center justify-between">
            <div className="text-xl text-[#B3B3B3]">
              ...
              <Link href="/login" className="text-[#303030] ml-1 underline">
                Log in
              </Link>
            </div>
            <button
